...
const ArtworkUpload = () => {
  ...
  const handlePublish = async (e) => {
    ...
    try {
     ...
     await dispatch(createArtwork(formData)).unwrap();
     console.log("Artwork published successfully:", );
      dispatch(
        showNotification({
          type: "success",
      ...
      dispatch(
        showNotification({ type: "error", message: "Profile published failed" })
      );
      setTimeout(() => {
        dispatch(hideNotification());
      }, 3000);
          ...
          >
            ...
            <div {...getRootProps()} className={`  p-10   `}>
              ...
              <div className="text-center">
                <button
                  className="bg-gray-800 hover:bg-gray-700 text-gray-200 font-semibold py-2 px-8 rounded mb-2"
                  onClick={open}
                >
